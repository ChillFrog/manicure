...
import example_img from "../assets/2_hands_with_nails.jpg";
    ...
    <div className="min-h-max bg-slate-100 md:min-h-screen">
      <nav className=" flex items-center justify-between bg-indigo-500 p-3 shadow">
        <div className="flex items-center justify-between">
          <img className="mr-10 w-12" alt=" logo" src={nails_logo}></img>
      ...
      <div className="flex flex-col-reverse justify-between p-10 lg:flex-row ">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className=" mb-3  flex w-96 flex-col items-center justify-center overflow-hidden rounded-xl bg-white shadow-lg md:w-72">
            <img src={nails_logo} alt="logo" className="mt-5 w-32" />
            <div className="py-4 px-4">
              <div className="mb-2 text-center text-xl font-medium tracking-tight">
                Вход в аккаунт
              </div>
          ...
          <div className="w-96 max-w-sm overflow-hidden rounded-xl bg-white p-3 shadow-lg md:w-72">
            <div className="mx-4 flex flex-col items-center justify-center">
